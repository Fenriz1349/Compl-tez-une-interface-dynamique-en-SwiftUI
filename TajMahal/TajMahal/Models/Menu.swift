...
enum Menu : CaseIterable {
    ...
    var dish: Dish {
        ...
        case .samosas : Dish(name: "Samosas aux légumes",
                             ...
                             spiceLevel: .light,
                             imageName: .samosas)
        case .pakoras : Dish(name: "Pakoras", 
                            category: .appetizer,
                            ...
                            spiceLevel: .medium,
                            imageName: .pakoras)
        case .aloo : Dish(name: "Aloo Tikki",
                            category: .appetizer,
        ...
        case .tikkaMasala: Dish(name: "Chicken Tikka Masala",
                            ...
                            price: 13,
                            ingredients: "Poulet, oignon, tomates en purée, crème fraîche, crème de coco, huile, beurre clarifié (ghee), ail, gingembre, poudre de curcuma, poudre de cumin, poudre de coriandre, piment en poudre, sel, coriandre fraîche.",
                            spiceLevel: .medium,
                            imageName: .tikkaMasala)
        case .biryani : Dish(name: "Biryani aux légumes",
                            category:.mainCourse,
                            ...
                            spiceLevel: .medium,
                            imageName: .biryani)
        case .roganJosh : Dish(name: "Rogan Josh",
                           category:.mainCourse,
